...
export const Navbar = () => {
  ...
  return (
    <Fragment>
      ...
      <aside
        className={`flex xl:hidden w-[75vw] md:w-[35vw] lg:w-[30vw] h-screen bg-slate-50 absolute duration-500 z-10 flex-col py-[5vh] lg:py-0 pl-[10vw] md:pl-[7vw] lg:pl-[5vw] gap-5 justify-between shadow-xl ${
